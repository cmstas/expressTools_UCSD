...
merged_dir=` echo /hadoop/cms/store/user/yanjuntu/CMSSW_4_2_3_patch1_V04-02-15 ` #change
dataset_dir_tmp=`echo $dataset_name |sed -e 's?/?_?g' `
dataset_dir=`echo ${dataset_dir_tmp:1} `
merged_file_dir=`echo $merged_dir/${dataset_dir}/CMSSW_4_2_3_patch1_V04-02-15_merged/${cms2_tag} ` #change
...
if [ ${dataset_name} == "/DoubleElectron/Run2011A-May10ReReco-v1/AOD" ]; then
...
if [ ${dataset_name} == "/DoubleMu/Run2011A-May10ReReco-v1/AOD" ]; then
