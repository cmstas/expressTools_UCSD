...
# #### USER SET VARIABLES ####
# LogDir="/home/users/imacneill/public_html/prompt_ntuple_log"
# NFSDir="/nfs-4/userdata/imacneill"
# SkimFilters="tagAndProbeSkim DoubleMuTriggerSkim DoubleElectronTriggerSkim"
...
# [ ! -d "${NFSDir}/$DatasetDir/$CMS2Tag/skim_log" ] && echo did no find skim log
